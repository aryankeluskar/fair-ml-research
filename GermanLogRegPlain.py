...
for repetition in range(ITERATIONS):
    ...
    # read german data, standardize it, and split into train and test sets
    def german_credit_data():
        ...
        print("data: ", data)
        print("foreign: ", data['Foreign Worker'])
    ...
    privileged_group_indices = [index for index, row in adult_data.iterrows() if row['Foreign Worker'] < 0]
    ...
    with open("PlainGermanCorrected.txt", "a") as file:
